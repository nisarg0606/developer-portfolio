...
function Navbar() {
    ...
    const { theme, setHandleDrawer, setTheme, themeType } = useContext(ThemeContext);
                    ...
                    <div className='navLink--container'>
                        ...
                        <Fade left>
                            <NavLink to='/#education' smooth={true} spy='true' duration={2000}>
                                <div className={classes.drawerItem}>
                                    <FaBookOpen className={classes.drawerIcon} />
                        ...
                        <Fade left>
                            <NavLink to='/#experience' smooth={true} spy='true' duration={2000}>
                                <div className={classes.drawerItem}>
                                    <RiComputerFill className={classes.drawerIcon} />
